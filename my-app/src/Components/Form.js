...
const MyForm = () => {
  ...
  const validationSchema = Yup.object().shape({
     ...
     writer: Yup.string().required('Please input your password!'),
      releasedate : Yup.string().required('Please select something from TreeSelect!'),
      avatar: Yup.string().
      required('Please select something from Select Option!')
  });
      ...
      >
        ...
        >
         ...
         >
           {
            writers.map((writer)=>{
              return <Select.Option value={writer} key={writer}>{writer}</Select.Option>
            })
           }
         </Select>
        </Form.Item>
